package ir.waspar.www.persiantextjustify;
...
public class FarshidTextView extends TextView{
    ...
    private boolean JustifiedEnabled = false;
    ...
    public FarshidTextView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public FarshidTextView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.setPadding(10, 0, 10, 10);
    }

    public FarshidTextView(Context context)
    {
        super(context);
        this.setPadding(10, 0, 10, 10);
    }
    ...
    public void setText(String st, boolean isJustified)
    {
        JustifiedEnabled = isJustified;
        super.setText(st);
    }
